...
export type IncrementInstruction<
  TProgram extends string = typeof SOL_MTREE_PROGRAM_ADDRESS,
...
export async function getIncrementInstructionAsync<
  TAccountCounter extends string,
  TAccountAuthority extends string,
  TProgramAddress extends Address = typeof SOL_MTREE_PROGRAM_ADDRESS,
>(
...
> {
  // Program address.
  const programAddress = config?.programAddress ?? SOL_MTREE_PROGRAM_ADDRESS;
